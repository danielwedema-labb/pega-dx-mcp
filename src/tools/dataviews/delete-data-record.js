  ...
  static getDefinition() {
    return {
      ...
      inputSchema: z.object({
        dataViewID: z.string().describe('ID of savable Data Page containing the record to delete. a valid data page identifier configured for delete operations.'),
        dataViewParameters: z.string().describe('Primary key(s) as JSON string to uniquely identify the data record to delete. a valid JSON object containing key-value pairs. For example: "{\\"CustomerID\\": \\"12345\\"}" or "{\\"OrderID\\": \\"O-1001\\", \\"CustomerID\\": \\"C-5678\\"}". Note: String format like "CustomerID=12345" will cause validation errors.'),
